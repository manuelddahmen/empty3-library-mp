...
public class DipSnake /*extends ParametricCurve*/ {
    ...
    public double pointsIn(PixM original) {
        ...
        //m.fillIn(this, new ColorTexture(Color.newCol(0f,0f,0f)), new ColorTexture(Color.newCol(1f,1f,1f)));
        double moy = 0.0;
        int countIn = 0;
    ...
    public double pointsOut(M original) {
        ...
        //m.fillIn(this, new ColorTexture(Color.newCol(1f,1f,1f)), new ColorTexture(Color.newCol(1f,1f,1f)));
        for (int l = 0; l < original.getLines(); l++)
            for (int c = 0; c < original.getColumns(); c++) {
