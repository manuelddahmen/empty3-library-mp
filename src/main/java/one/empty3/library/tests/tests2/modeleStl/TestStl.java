...
package one.empty3.library.tests.tests2.modeleStl;
...
public class TestStl extends TestObjetSub {
    ...
    public void ginit() {
        ...
        TextureCol colorTexture0 = new TextureCol(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random()));
        ...
        s.texture(new TextureCol(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random())));
