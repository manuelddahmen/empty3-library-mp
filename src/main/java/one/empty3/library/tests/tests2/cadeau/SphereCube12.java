...
public class SphereCube12 extends TestObjetSub {
    ...
    public void ginit() {
        ...
        s.texture(new TextureCol(one.empty3.libs.Color.newCol(0.0f,0.f,1f)));
        ...
        scene().lumieres().add(new LumierePonctuelle(Point3D.O0, one.empty3.libs.Color.newCol(0.0f,1.0f,0f)));
    }
