...
public class TestObjTeapot extends TestObjetSub {
    ...
    public void ginit() {
        ...
        modelLoaderOBJ.texture(new ColorTexture(one.empty3.libs.Color.newCol(0.0f,0.0f,0.0f)));
        scene().texture(new ColorTexture(one.empty3.libs.Color.newCol(1.0f,1.0f,1f)));
