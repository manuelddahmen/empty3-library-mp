 ...
 * *
 */
package one.empty3.library.tests.tests2.trigenerateurabstract.triextrusiongeneralisee;
...
public class TestCylindre extends TestObjetSub {
    ...
    public void ginit() {
        ...
        CheminDroite cd = new CheminDroite(new LineSegment(Point3D.X, Point3D.Y, new TextureCol(one.empty3.libs.Color.newCol(1.0f,1.0f,1f))));
        ...
        eg.texture(new TextureCol(one.empty3.libs.Color.newCol(1.0f,1.0f,1f)));
