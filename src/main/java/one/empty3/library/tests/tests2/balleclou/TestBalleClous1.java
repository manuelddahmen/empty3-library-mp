...
public class TestBalleClous1 extends TestObjetSub {
    ...
    public void ginit() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            s[i].texture(new TextureCol(one.empty3.libs.Color.newCol(1.0f,1.0f,1f)));
        ...
        tc =
                new TextureImg(
                        new Image(Image.staticLoadFile(new File("samples/img/manu.jpg"))));
        ...
        scene().lumieres().add(new LumierePonctuelle(Point3D.Z, one.empty3.libs.Color.newCol(0.0f, 0.0f, 1f)));
