...
package one.empty3.library.tests.tests2.transparence;
...
public class TestTransparence extends TestObjetSub {
    ...
    public void testScene() throws Exception {
        ...
        TextureImg TextureCol = new TextureImg(new one.empty3.libs.Image(Image.staticLoadFile(new File(getClass().getResource("be.manudahmen.empty3.tests.tests2.cubes-be.manudahmen.empty3.tests.tests2.transparence.png").getFile()))));
        //TextureCol.setTransparent(one.empty3.libs.Color.newCol(0.0f,1.0f,0f));
