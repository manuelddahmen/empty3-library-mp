 ...
 * 2013 Manuel Dahmen
 */
package one.empty3.library.tests.tests2.horloge;
...
public class Horloge extends JFrame {
    ...
    public void initTime() {
        ...
        Sphere sG9 = new Sphere(position(f * 9.0 / 12)
                .mult(80d), 10);
        sG0.texture(new TextureCol(one.empty3.libs.Color.newCol(0.0f,1.0f,0f)));
        sG3.texture(new TextureCol(one.empty3.libs.Color.newCol(0.0f,1.0f,0f)));
        sG6.texture(new TextureCol(one.empty3.libs.Color.newCol(0.0f,1.0f,0f)));
        sG9.texture(new TextureCol(one.empty3.libs.Color.newCol(0.0f,1.0f,0f)));
        s0.texture(new TextureCol(one.empty3.libs.Color.newCol(1.0f,1.0f,1f)));
        sH.texture(new TextureCol(Color.newCol(1f, 0f, 1f)));
        sM.texture(new TextureCol(one.empty3.libs.Color.newCol(0,0,1)));
        sS.texture(new TextureCol(one.empty3.libs.Color.newCol(1.0f,0.0f,0f)));
        s0.texture(new TextureCol(one.empty3.libs.Color.newCol(1.0f,0.0f,0f)));
        sH.texture(new TextureCol(one.empty3.libs.Color.newCol(0.0f,1.0f,0f)));
        sM.texture(new TextureCol(one.empty3.libs.Color.newCol(0,0,1)));
        sS.texture(new TextureCol(one.empty3.libs.Color.newCol(0.0f, 0.0f, 1f)));

        for (int i = 0; i < 12; i++) {
            TRISphere sGm = new TRISphere(position(f * i / 12)
                    .mult(80d), 6);
            sGm.texture(new TextureCol(one.empty3.libs.Color.newCol(0,0,1)));
            sc.add(sGm);
        }
        sc.add(s0);
        sc.add(sH);
        ...
        droite0 = new LineSegment(
                ...
                Point3D.O0, new TextureCol(one.empty3.libs.Color.newCol(0.0f,1.0f,0f)));
        droite1 = new LineSegment(position(f * d.getHours() / 12).mult(60d),
                Point3D.O0, new TextureCol(one.empty3.libs.Color.newCol(0,0,1)));
        droite2 = new LineSegment(
                position(f * d.getHours() / 12).mult(60d),
                Point3D.O0, new TextureCol(one.empty3.libs.Color.newCol(1.0f,0.0f,0f)));
        sc.add(droite0);
        sc.add(droite1);
        sc.add(droite2);
    ...
    public void montrer() {
        ...
        while (montre) {
            ...
            time();
            z.next();
            z.couleurDeFond(new TextureCol(one.empty3.libs.Color.newCol(1.0f,1.0f,1f)));
            z.scene(sc);
