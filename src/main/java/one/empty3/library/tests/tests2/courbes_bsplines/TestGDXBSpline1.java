...
package one.empty3.library.tests.tests2.courbes_bsplines;
...
public class TestGDXBSpline1 extends TestObjet {
    ...
    public void finit() {
        ...
        b.texture(new TextureCol(one.empty3.libs.Color.newCol(1.0f,1.0f,1f)));
        ...
        t.setDiameter(1);
        t.nbrRotations(10);
        t.texture(new TextureCol(one.empty3.libs.Color.newCol(1.0f,1.0f,1f)));
