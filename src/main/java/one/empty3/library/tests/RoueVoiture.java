...
public class RoueVoiture extends RepresentableConteneur {
    ...
    public RoueVoiture(Voiture voiture) {
        ...
        t.texture(new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random())));
        ...
        t2.texture(new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random())));
        ...
        t3.texture(new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random())));
        ...
        t4.texture(new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random())));
