...
public class TestPlanets2 extends TestObjetSub {
    ...
    public static void main(String[] args) {
        one.empty3.library.tests.TestPlanetEtLune1
                testPlanets = new one.empty3.library.tests.TestPlanetEtLune1();
    ...
    public void ginit() {
        ...
        sun.texture(new TextureInvertU(new one.empty3.libs.Image(Image.staticLoadFile(sunFilename))));
        earth.texture(new TextureInvertU(new one.empty3.libs.Image(Image.staticLoadFile(earthFilename))));
        moon.texture(new TextureInvertU(new one.empty3.libs.Image(Image.staticLoadFile(moonFilename))));
