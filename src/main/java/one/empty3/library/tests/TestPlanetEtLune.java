...
public class TestPlanetEtLune extends TestObjetSub {
    ...
    public void ginit() throws IOException {
        ...
        sun.texture(new ImageTexture(new one.empty3.libs.Image(Image.staticLoadFile(sunFilename))));
        earth.texture(new ImageTexture(new one.empty3.libs.Image(Image.staticLoadFile(earthFilename))));
        moon.texture(new ImageTexture(new one.empty3.libs.Image(Image.staticLoadFile(moonFilename))));
