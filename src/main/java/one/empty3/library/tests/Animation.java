...
public class Animation extends Representable {
    private final HashMap<Class, one.empty3.tests.MoveCollection> animations = new HashMap<>();

    public Animation(Class<? extends Representable> anime, one.empty3.tests.MoveCollection moveCollection) {
