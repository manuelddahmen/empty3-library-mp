...
public class Balade extends TestObjetSub {
    ...
    public void ginit() {
        ...
        imageTextureTrunk = new ImageTexture(new Image(Objects.requireNonNull(Image.staticLoadFile(new File("resources/img/CIMG0454-modif-cs4.jpg")))));
        ciel_ensoleille = new ImageTexture(new Image(Objects.requireNonNull(Image.staticLoadFile(new File("resources/ciel_ensoleille.jpg")))));
        sol_sableux = new ImageTexture(new Image(Objects.requireNonNull(Image.staticLoadFile(new File("res/img/planets2/others/8k_saturn_ring_alpha.png")))));
