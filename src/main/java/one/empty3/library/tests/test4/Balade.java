...
public class Balade extends TestObjetSub {
    ...
    public void ginit() {
        ...
        try {
            imageTextureTrunk = new ImageTexture(new one.empty3.libs.Image(Objects.requireNonNull(Image.staticLoadFile(new File("resources/img/CIMG0454-modif-cs4.jpg")))));
