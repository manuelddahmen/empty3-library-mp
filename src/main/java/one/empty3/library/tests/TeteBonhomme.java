...
public class TeteBonhomme extends RepresentableConteneur {
    ...
    public void init() {
        ...
        hemisphere.texture(new ColorTexture(one.empty3.libs.Color.newCol(0.0f,0.0f,1f)));
        hemisphere2.texture(new ColorTexture(one.empty3.libs.Color.newCol(1.0f,0.0f,0f)));
        ...
        tubeExtrusion.texture(new ColorTexture(one.empty3.libs.Color.newCol(0,0,1)));
