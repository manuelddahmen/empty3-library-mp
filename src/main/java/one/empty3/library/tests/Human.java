...
package one.empty3.library.tests;
...
import one.empty3.testscopy.tests.Move;
import one.empty3.testscopy.tests.MoveCollection;
...
public class Human extends RepresentableConteneur {
    ...
    public void walking() {
        ...
        one.empty3.testscopy.tests.Move teteBas = new one.empty3.testscopy.tests.Move("humanWalks1", tete.getRepresentable(), "circle,axis,p1",
                0.0, 3.0, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move teteHaut = new one.empty3.testscopy.tests.Move("humanWalks2", tete.getRepresentable(), "circle,axis,p2",
                0.0, 3.0, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move piedGaucheWalk0 = new one.empty3.testscopy.tests.Move("humanWalks3", piedGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move piedDroiteWalk0 = new one.empty3.testscopy.tests.Move("humanWalks4", piedDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move piedGaucheWalk1 = new one.empty3.testscopy.tests.Move("humanWalks5", piedGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(0.0, 0.0, distancePas2));
        one.empty3.testscopy.tests.Move piedDroiteWalk1 = new one.empty3.testscopy.tests.Move("humanWalks6", piedDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(0.0, 0.0, distancePas2));
        one.empty3.testscopy.tests.Move jbg1 = new one.empty3.testscopy.tests.Move("humanWalks7", jambeBasGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move jbg2 = new one.empty3.testscopy.tests.Move("humanWalks8", jambeBasGauche.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move jbd1 = new one.empty3.testscopy.tests.Move("humanWalks9", jambeBasDroite.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move jbd2 = new one.empty3.testscopy.tests.Move("humanWalks10", jambeBasDroite.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move jhg1 = new one.empty3.testscopy.tests.Move("humanWalks11", jambeHautGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move jhg2 = new one.empty3.testscopy.tests.Move("humanWalks12", jambeHautGauche.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move jhd1 = new one.empty3.testscopy.tests.Move("humanWalks13", jambeHautDroite.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move jhd2 = new one.empty3.testscopy.tests.Move("humanWalks14", jambeHautDroite.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move bhg1 = new one.empty3.testscopy.tests.Move("humanWalks15", brasHautGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0., 0.));
        one.empty3.testscopy.tests.Move bhg2 = new one.empty3.testscopy.tests.Move("humanWalks16", brasHautGauche.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0., 0.0));
        one.empty3.testscopy.tests.Move bhd1 = new one.empty3.testscopy.tests.Move("humanWalks17", brasHautDroit.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move bhd2 = new one.empty3.testscopy.tests.Move("humanWalks18", brasHautDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move bbg1 = new one.empty3.testscopy.tests.Move("humanWalks19", brasBasGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move bbg2 = new one.empty3.testscopy.tests.Move("humanWalks20", brasBasDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move bbd1 = new one.empty3.testscopy.tests.Move("humanWalks21", brasBasGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.testscopy.tests.Move bbd2 = new Move("humanWalks22", brasBasDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
