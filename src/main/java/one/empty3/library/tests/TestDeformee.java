...
import one.empty3.library.tests.test4.surfacest.SphereDiform;
...
*/
        ...
        LumierePonctuelle lumierePointSimple = new LumierePonctuelle(Point3D.X.mult(1000.0), one.empty3.libs.Color.newCol(0.0f,0.0f,0.0f));
