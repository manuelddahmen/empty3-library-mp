...
public class TestPlanets9 extends TestObjetSub {
    ...
    public void ginit() throws IOException {
        ...
        ImageTexture imageTexture = new ImageTexture(new one.empty3.libs.Image(Objects.requireNonNull(Image.staticLoadFile(
...
*/
    ...
    public void finit() throws Exception {
        ...
        earth.texture(new TextureInvertU(
                new one.empty3.libs.Image(Objects.requireNonNull(Image.staticLoadFile(images
                        .get(palier))))));
