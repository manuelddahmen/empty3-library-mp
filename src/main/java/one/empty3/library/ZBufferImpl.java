    ...
    public void tracerTriangle(Point3D pp1, Point3D pp2, Point3D pp3,
        ...
        double iteres1 = minMaxOptimium.computeIncr((1 + mathUtilPow2(p1, p2)));
            for (double a = 0; a < 1.0; a += iteres1) {
                ...
                if (pp != null) {
                    double iteres2 = 1 + mathUtilPow2(p3, pp);
                    double v = minMaxOptimium.computeIncr(iteres2);
                    Point3D p3ab;
                    for (double b = 0; b <= 1.0/*Math.sqrt(p3a.moins(pp3).norme()*p3a.moins(pp3).norme()
                        -pp2.moins(pp1).norme()*pp2.moins(pp1).norme())>=b*/; b += v) {
        ...
        public boolean testDeep(Point3D x3d, int c) {
            ...
            if (x >= 0 & x < la & y >= 0 & y < ha
                ...
                if (toDrawR != null) {
                    ...
                    ime.setElementRepresentable(x, y, deep, n);
                }
                return true;
            }
            return false;
