...
//        for(double intensity=1.0; intensity>=0.4; intensity-=0.1) {
    ...
    public boolean process(File in, File out) {
        ...
        for (int i = 0; i < levels; i++) {
            ...
            Image img = file;
            Image img2 = new one.empty3.libs.Image(img.getWidth(), img.getHeight());
            Image img3 = new one.empty3.libs.Image(img.getWidth(), img.getHeight());
            Image img4 = new one.empty3.libs.Image(img.getWidth(), img.getHeight());
