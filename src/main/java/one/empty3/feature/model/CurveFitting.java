...
import one.empty3.feature.model.shape.Rectangle;
...
public class CurveFitting extends ProcessFile {
    ...
    */
    ...
    public boolean process(File in, File out) {
        ...
        inPix.fillIn(curveInitial, new ColorTexture(new Color(Color.newCol(1f, 1f, 1f))), new ColorTexture(new Color(one.empty3.libs.Color.newCol(1.0f, 0.0f, 0f))));
        outPix.paintAll(new double[]{1, 1, 1});
        outPix.fillIn(curveInitial, new ColorTexture(new Color(Color.newCol(0f, 0f, 0f))), new ColorTexture(new Color(one.empty3.libs.Color.newCol(1.0f, 0.0f, 0f))));
        ...
        //inPix.paintAll(new double[]{0, 0, 0});
        //outPix.paintAll(new double[]{1, 1, 1});
        inPix.fillIn(curvePoints, new ColorTexture(new Color((Color.newCol(1f,1f,1f)))), new ColorTexture(new Color(Color.newCol(1f,1f,1f))));
        outPix.fillIn(curvePoints, new ColorTexture(new Color(Color.newCol(0f,0f,0f))), new ColorTexture(new Color(Color.newCol(0f,0f,0f))));
        ...
        p.plotCurve(curvePoints, new ColorTexture(new Color(Color.newCol(1f,1f,1f))));
        System.out.println("Courbe 5/5");
        p.plotCurve(circle, new ColorTexture(new Color(one.empty3.libs.Color.newCol(0, 0, 1))));
