...
import one.empty3.feature.model.kmeans.MakeDataset;
import one.empty3.feature.model.kmeans.ReadDataset;
...
public class DBScan extends ProcessFile {
    ...
    public boolean process(File in, File out) {
        try {
            ...
            PixM p = PixM.getPixM(Objects.requireNonNull(new one.empty3.libs.Image(in)), maxRes);
