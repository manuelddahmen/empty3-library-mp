...
public class TestPlanetEtLune1 extends TestObjetSub {
    ...
    public void ginit() throws IOException {
        ...
        sun.texture(new TextureInvertU(new  one.empty3.libs.Image(javax.imageio.ImageIO.read(sunFilename))));
        earth.texture(new TextureInvertU(new  one.empty3.libs.Image(javax.imageio.ImageIO
                .read(earthFilename))));
        moon.texture(new TextureInvertU(new  one.empty3.libs.Image(javax.imageio.ImageIO
                .read(moonFilename))));
