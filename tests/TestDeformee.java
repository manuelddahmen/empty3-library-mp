...
public class TestDeformee extends TestObjetSub {
    ...
    public void ginit() throws IOException {
        ...
        earth.texture(new TextureInvertU(new  one.empty3.libs.Image(javax.imageio.ImageIO.read(earthFilename))));
        moon.texture(new TextureInvertU(new  one.empty3.libs.Image(javax.imageio.ImageIO.read(moonFilename))));
