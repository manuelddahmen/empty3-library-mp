...
public class Sunset extends TestObjetSub {
    ...
    public void ginit() {
        super.ginit();
        imageTextureTrunk = new ImageTexture(new  one.empty3.libs.Image(ImageIO.read(new File("resources/img/CIMG0454-modif-cs4.jpg"))));
        ciel_ensoleille = new ImageTexture(new  one.empty3.libs.Image(ImageIO.read(new File("resources/ciel_ensoleille.jpg"))));
        sol_sableux = new ImageTexture(new  one.empty3.libs.Image(ImageIO.read(new File("resources/sol_sableux.jpg"))));
    }
