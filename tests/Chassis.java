...
public class Chassis extends RepresentableConteneur {
    ...
    public void init() {
        ...
        add(new Polygon(new Point3D[]{
                ...
                P.n(voiture.getLongueur() / 2, 20, -largeur),
                P.n(voiture.getLongueur() / 2, 20, largeur),
                P.n(-voiture.getLongueur() / 2, 20, largeur)}, new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random()))
        ));
        add(new Polygon(new Point3D[]{
                P.n(-voiture.getLongueur() / 2, 40., -largeur),
                P.n(voiture.getLongueur() / 2, 40., -largeur),
                P.n(voiture.getLongueur() / 2, 40., largeur),
                P.n(-voiture.getLongueur() / 2, 40., largeur)}, new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random()))
        ));
        ...
        add(new Polygon(new Point3D[]{
                ...
                P.n(-voiture.getLongueur() / 2, 20., largeur - voiture.getEpaisseurRoue()),
                P.n(-voiture.getLongueur() / 2 - voiture.getRayonRoue() - voiture.getEspacementRoues(), 20., largeur - voiture.getEpaisseurRoue())}, new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random()))
        ));
        add(new Polygon(new Point3D[]{
                ...
                P.n(-voiture.getLongueur() / 2, 40., largeur - voiture.getEpaisseurRoue()),
                P.n(-voiture.getLongueur() / 2 - voiture.getRayonRoue() - voiture.getEspacementRoues(), 40., largeur - voiture.getEpaisseurRoue())}, new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random()))
        ));
        // 2 pour l'avant
        add(new Polygon(new Point3D[]{
                P.n(-voiture.getLongueur() / 2 - voiture.getRayonRoue() - voiture.getEspacementRoues(), 20., -largeur + voiture.getEpaisseurRoue()),
        ...
        add(new Polygon(new Point3D[]{
                ...
                P.n(voiture.getLongueur() / 2 + voiture.getRayonRoue() + longueurAvant, 20., largeurMuseau)}, new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random()))
        ));
        add(new Polygon(new Point3D[]{
                ...
                P.n(voiture.getLongueur() / 2 + voiture.getRayonRoue() + longueurAvant, 40., largeurMuseau)}, new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random()))
        ));
        // Coffre et arrière
        add(new Polygon(new Point3D[]{
                ...
                P.n(-voiture.getLongueur() / 2 - voiture.getRayonRoue(), 20., -largeurMuseau),
                P.n(-voiture.getLongueur() / 2 - voiture.getRayonRoue(), 20., largeurMuseau),
                P.n(-voiture.getLongueur() / 2 - voiture.getRayonRoue() + longueurArriere, 20., largeurMuseau)}, new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random()))
        ));
        add(new Polygon(new Point3D[]{
                P.n(-voiture.getLongueur() / 2 - voiture.getRayonRoue() + longueurArriere, 40., -largeurMuseau),
                P.n(-voiture.getLongueur() / 2 - voiture.getRayonRoue(), 40., -largeurMuseau),
                P.n(-voiture.getLongueur() / 2 - voiture.getRayonRoue(), 40., largeurMuseau),
                P.n(-voiture.getLongueur() / 2 - voiture.getRayonRoue() + longueurArriere, 40., largeurMuseau)}, new ColorTexture(one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random()))
        ));
        ...
        extrusionCurveCurve.getBase().setElem(new PolyLine(new Point3D[]{
                ...
                new Point3D(-10., voiture.getHauteurPorte() + 20., voiture.getLargeur()),
        }, one.empty3.libs.Color.newCol((float)Math.random(),(float)Math.random(),(float)Math.random())));
