...
public class TestCoeur extends TestObjetSub {
    ...
    public void ginit() {
        coeur = new Coeur();
        try {
            coeur.texture(new TextureImg(new  one.empty3.libs.Image(ImageIO.read(getClass().getResourceAsStream("be.manudahmen.empty3.tests.tests2.coeur.jpg")))));
        } catch (IOException ex) {
            coeur.texture(new TextureCol(0xFFC5D3));
