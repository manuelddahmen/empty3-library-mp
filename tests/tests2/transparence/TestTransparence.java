...
public class TestTransparence extends TestObjetSub {
    ...
    public void testScene() throws Exception {
        ...
        TextureImg TextureCol = new TextureImg(new  one.empty3.libs.Image(ImageIO.read(getClass().getResourceAsStream("be.manudahmen.empty3.tests.tests2.cubes-be.manudahmen.empty3.tests.tests2.transparence.png"))));
