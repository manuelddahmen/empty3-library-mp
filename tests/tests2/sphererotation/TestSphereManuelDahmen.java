...
package one.empty3.library.tests.tests2.sphererotation;
...
public class TestSphereManuelDahmen extends TestObjetSub {
    ...
    public void ginit() {
        ...
        try {
            TextureImg imageTexture = new TextureImg(new  one.empty3.libs.Image(ImageIO.read(this.getClass().getResourceAsStream("map2.png"))));
